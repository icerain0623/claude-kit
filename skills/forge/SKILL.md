---
name: forge
description: Use when planning a feature or design and you want to be interviewed relentlessly until the plan is fully specified. Starts as one-question-at-a-time chat to grasp the overview, then switches to document-based batched Q&A for details. Resumable — re-invoke to continue.
---
